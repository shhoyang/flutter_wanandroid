...
class WechatArticleController extends BaseListController<Article> with SingleGetTickerProviderMixin {
  final int authorId;
  ...
  void loadData([int page]) {
    DioManager.of().get(ApiService.getUrl(ApiService.wechatArticle, id: authorId, page: page), (data) {
